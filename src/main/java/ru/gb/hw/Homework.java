...
public class Homework {
  ...
  public static void main(String[] args) {
      ...
      //Проверка на создание номеров билета
      System.out.println("Создался номер билета " + generator.createNewNumber());


     //Добавляем билеты в список, для сохранения
     listTicket.add(scoreboard.newTicket());
     listTicket.add(scoreboard.newTicket());
     listTicket.add(scoreboard.newTicket());

     for (Ticket ticket : listTicket) System.out.println(ticket);
  }
}
